...
RSpec.describe 'User index page', type: :system do
  describe 'User show page' do
    before(:each) do
      @user = User.create!(name: 'Mark', photo: '#photo_mark', bio: 'My bio #mark !', email: 'mark@test.com', password: 'mark123456',
                           posts_counter: 0)
      ...
      fill_in 'user_email',	with: 'mark@test.com'
      fill_in 'user_password',	with: 'mark123456'
      click_button 'Log in'
    ...
    it 'I can see the user"s bio' do
      expect(page).to have_content 'My bio #mark !'
    end
